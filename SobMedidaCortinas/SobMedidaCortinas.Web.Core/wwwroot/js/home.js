...
$(function () {
    setTimeout(function () {
        ...
        var modalTemplate =
            ...
            '<img class="img-responsive img-centered" data-src="/img/cortinas/<%=id%>.jpg" alt="" itemprop="image">' +
        ...
        var portfolioItemTemplate = '<div class="col-md-4 col-sm-6 portfolio-item" itemscope itemtype="http://schema.org/Product">' +
            ...
            '<img src="/img/cortinas/<%=id%>-tb.jpg" class="img-responsive" alt=<%=name%> itemprop="image">' +
            '</a>' +
